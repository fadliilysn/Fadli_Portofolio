...
const experiences = [
  {
    ...
    type: "Internship",
    summary:
      "Mengembangkan dan mendokumentasikan REST API untuk modul Autentikasi dan Manajemen Email yang dikonsumsi langsung oleh tim frontend React.",
    highlights: [
      "Merancang dan mengimplementasikan 9+ endpoint REST API untuk modul autentikasi pengguna dan pemrosesan email.",
